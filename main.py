...
from search_engine import query_search_engine

def get_seeds(organization):
    seeds = []
    # Load static seeds
    ...
    # Load search engines
    with open("search_engine_links.txt") as f:
        engines = [line.strip() for line in f if line.strip()]

    # Query each engine
    for engine in engines:
        seeds.extend(query_search_engine(engine, organization))
